const ZeroCarbon = artifacts.require("./ZeroCarbon.sol");

const BigNumber = web3.BigNumber;

contract('ZeroCarbon', function(accounts) {

  describe('Contract Creation Tests', function() {

    beforeEach(async function () {
      this.token = await ZeroCarbon.new();
    });
  ...
  describe('ERC20 Functions test', function() {
    it('Test transfering money', function() {
      return ZeroCarbon.new().then(async function(instance) {
  ...
  it('Payment should not be accepted', function() {
    return ZeroCarbon.new().then(function(instance) {
  ...
  describe('transfer Any ERC20 Token', function() {
    beforeEach(async function () {
      this.tokenA = await ZeroCarbon.new({from: accounts[0]});
      this.tokenB = await ZeroCarbon.new({from: accounts[1]});
    });
